...
// Aqui podemos encontrar el contenido que esta en cada tabla correspondiente a su funcionalidad.
// Usuarios
	$sql_usuario ="ALTER TABLE tb_ayuda
...
// Aqui podemos encontrar el contenido que esta en cada tabla correspondiente a su funcionalidad.
// Listado de sintomas de los animales.

	$sql_sintomas ="INSERT INTO tb_sintomas (id_sintomas, sintomas) VALUES
	(1, 'tos'),
	(2, 'dolor muscular'),
	(3, 'vomitos'),
...
// Aqui podemos encontrar el contenido que esta en cada tabla correspondiente a su funcionalidad.
// relacion de sintomas para di.

	$sql_relacion ="INSERT INTO tb_relacion (id_relacion, id_sintomas, id_enfermedad) VALUES
	(1, 1, 1),
	(2, 2, 1),
	(3, 3, 1),
	(4, 4, 1),
	...
	$sql_enfermedad ="INSERT INTO tb_enfermedad (id_enfermedad, enfermedad, url) VALUES
